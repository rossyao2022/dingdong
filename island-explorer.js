...
(() => {
 ...
 function render(){return `<div class="wonder-heading v4-heading"><div><span class="wonder-eyebrow">DINGDONG EXPLORER CLUB · RIASEC</span><h1>发现兴趣，<em>认识独特的你。</em></h1><p>喜欢什么、怎样学习、如何陪伴，每一个方向都值得慢慢探索。</p></div></div>
